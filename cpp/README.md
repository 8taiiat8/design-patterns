# Design Patterns in C++ — the RoboWorks story
...
A Chinese version of the code lives in [`cpp-zh/`](../cpp-zh/) with its
own [中文学习指南](../document/roboworks-study-guide-zh.html).
